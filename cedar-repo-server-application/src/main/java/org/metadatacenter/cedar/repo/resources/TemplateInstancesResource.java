  ...
  @ApiResponses({
      ...
      @ApiResponse(responseCode = "401", content = @Content(schema = @Schema(implementation = CedarError.class)),
          description = "The request carries no valid credentials, or the caller has no read access "
              ...
              + "than 403."),
      @ApiResponse(responseCode = "403", content = @Content(schema = @Schema(implementation = CedarError.class)), description = "The caller lacks the template instance read permission"),
