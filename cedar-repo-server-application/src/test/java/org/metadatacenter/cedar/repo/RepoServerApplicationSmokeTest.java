...
public class RepoServerApplicationSmokeTest {
  ...
  @ClassRule
  public static final DropwizardAppRule<RepoServerConfiguration> SERVER =
      new DropwizardAppRule<>(RepoServerApplication.class, ResourceHelpers.resourceFilePath("test-config.yml"));
